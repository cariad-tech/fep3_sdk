...
|     :end-before: //End(Instantiation)                                          | Create a custom class that is derived from :ref:`label_cpp_datajob`            |
|     :dedent: 4                                                                 | to implement the functionality of the FEP Element (MyDataJob in this example). |
|                                                                                |                                                                                |
...
The PropertyTree has been replaced by the :ref:`label_configuration_service`.
...
|                              |     :start-after: //Begin(Muting)                                              | programmed to have the same functionality like so:                             |
